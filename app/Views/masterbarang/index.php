...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mt-3 mb-4 text-gray-800">Daftar Alat Tulis</h1>
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">Daftar Alat Tulis</h4>
                        <div class="d-flex my-xl-auto right-content">
                            <div class="mb-3 mb-xl-0" style="margin-right: 10px;">
                                <a href="<?= base_url('/masterbarang/create'); ?>" class="btn btn-success"><i class="mdi mdi-plus"></i> Tambah</a>
                            </div>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($master_barang as $mb) : ?>
                                    <tr>
                                        ...
                                        <td><?= $mb['stok_awal']; ?></td>
                                        <td>
                                            <a href="/masterbarang/edit/<?= $mb['id']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                                            <?php echo anchor('masterbarang/delete/' . $mb['id'], '<div class="btn btn-danger btn-sm"><i class = "fa fa-trash"></i></div>') ?>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
